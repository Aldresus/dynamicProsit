...
export default function Presentation({ prosit }: PresentationProps) {
  return (
    <div className="h-full w-full flex flex-col gap-6 overflow-y-scroll overflow-x-hidden ">
      ...
      <Group dir="row">
        <Stack
          gap="md"
          className="w-full h-full whitespace-break-spaces overflow-hidden"
        >
          <PresentationElement
            anchor="motsClefs"
            titre={"Mots-clefs"}
            ...
            color={prosit.currentAnchor === "motsClefs" ? "blue.9" : undefined}
            className={twMerge(
        ...
        <Stack>
          <PresentationElement
            ...
            className={twMerge(
              prosit.problematiques.length === 0 ? "opacity-0" : "opacity-100",
            )}
            bg={
          ...
          <PresentationElement
            ...
            bg={
              prosit.currentAnchor === "pistesDeSolution" ? "blue.1" : undefined
            }
            color={
              prosit.currentAnchor === "pistesDeSolution" ? "blue.9" : undefined
            }
          />
          <PresentationElement
            anchor="livrables"
            ...
            color={prosit.currentAnchor === "livrables" ? "blue.9" : undefined}
          />
          <PresentationElement
            anchor="planDAction"
            ordered
